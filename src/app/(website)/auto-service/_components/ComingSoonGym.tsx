...
function ComingSoonGym() {
  return (
    <section className="bg-[#020813] px-3 py-2 text-white sm:px-4">
      <div className="relative isolate mx-auto flex max-w-7xl flex-col overflow-hidden rounded-2xl border border-blue-300/15 bg-[#030b1c]/90 px-5 py-5 shadow-2xl shadow-black/50 sm:px-7 lg:px-8 lg:py-6">
        ...
        <main className="grid flex-1 items-center gap-8 py-7 lg:grid-cols-[0.84fr_1.16fr] lg:gap-12 lg:py-5">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="relative grid aspect-square w-full max-w-[420px] place-items-center xl:max-w-[460px]">
