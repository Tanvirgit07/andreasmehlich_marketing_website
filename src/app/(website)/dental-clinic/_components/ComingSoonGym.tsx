...
function ComingSoonGym() {
  ...
  return (
    <section className="h-[calc(100vh-40px)] overflow-hidden bg-[#020813] px-3 py-2 text-white sm:px-4 lg:h-[calc(100vh-64px)]">
      <div className="relative isolate mx-auto flex h-full max-w-7xl flex-col overflow-hidden rounded-2xl border border-blue-300/15 bg-[#030b1c]/90 px-5 py-4 shadow-2xl shadow-black/50 sm:px-7 lg:px-8 lg:py-5">
        ...
        <main className="grid min-h-0 flex-1 items-center gap-7 py-4 lg:grid-cols-[0.84fr_1.16fr] lg:gap-10 lg:py-3">
          <div className="max-w-xl">
            ...
            <h1 className="mt-4 max-w-lg text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-[52px]">
              Something Amazing{" "}
          ...
          <div className="flex min-h-0 flex-col items-center gap-5">
            <div className="relative grid aspect-square w-full max-w-[360px] place-items-center xl:max-w-[400px]">
